...
2. ФАСОВКА
   ...
   - Если заказанный объём ТОЧНО совпадает с объёмом другой фасовки из каталога
     (например, клиент просит 1 тонну пеллет в мешках по 15 кг, а в каталоге есть фасовка «биг-бэг 1000 кг»), то:
       • считай стоимость по фасовке «биг-бэг 1000 кг», а не как набор мешков;
       • в ответе обязательно объясни клиенту, что для 1 тонны есть отдельная фасовка биг-бэг
         и ты считаешь по её цене, это удобнее и соответствует условиям склада;
       • при желании клиента можешь посчитать эквивалент в мешках для сравнения, но итоговую
         цену всё равно бери из фасовки биг-бэг.
